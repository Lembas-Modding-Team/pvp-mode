...
public abstract class PartialItemDropEvent extends Event
{
    ...
    public static class Pre extends PartialItemDropEvent
    {
        ...
        {
            super (player);
            this.itemsToBeDropped = PvPUtils.deepUnmodifiableMap (itemsToBeDropped);
    ...
    public static class Post extends PartialItemDropEvent
    {
        ...
        {
            super (player);
            this.droppedItems = PvPUtils.deepUnmodifiableMap (droppedItems);
            this.removedItems = PvPUtils.deepUnmodifiableMap (removedItems);
            this.unprocessedItems = PvPUtils.deepUnmodifiableMap (unprocessedItems);
        }
