...
public class PvPServerEventHandler
{
    ...
    {
        if (server.isSoulboundItemsEnabled () && soulboundItems.containsKey (event.player))
        {
    ...
    {
        event.setCanceled (server.isSoulboundItemsEnabled () && PvPServerUtils.isSoulbound (event.getStack ()));
    }
