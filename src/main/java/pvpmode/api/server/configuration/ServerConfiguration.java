...
public interface ServerConfiguration extends CommonConfiguration
{
    ...
    public static final String SOULBOUND_ITEMS_ENABLED_CONFIGURATION_NAME = "Soulbound Items Enabled";
    ...
    public static final String CHAT_MESSAGES_CONFIGURATION_CATEGORY = SERVER_CONFIGURATION_CATEGORY
        + ".chat_messages";
    public static final String SOULBOUND_CONFIGURATION_CATEGORY = SERVER_CONFIGURATION_CATEGORY
        + ".soulbound";
