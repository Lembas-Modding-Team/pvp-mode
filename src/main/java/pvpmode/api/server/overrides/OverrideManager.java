...
/**
 * The override manager manages the conditional PvP mode overrides. Custom override conditions can
 * be registered here.
 *
 * @author CraftedMods
 */
public interface OverrideManager
{
    ...
    /**
     * Registers a new PvP override condition.<br> Override conditions can be registered everytime.
     *
    ...
    /**
     * Unregisters a new PvP override condition.<br> Override conditions can be unregistered
     * everytime.
     *
     * @param condition The condition to unregister
